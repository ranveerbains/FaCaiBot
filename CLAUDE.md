...
│   ├── order.rs                   # TradeSignal, ProfitTier, ExecutorCommand, ExecutorFeedback, FillMethod (3 variants: FavorableMaker, FavorableTaker, EmergencyTaker), Side, ExitReason (5 variants: BreakEvenBreach, MarketExpiry, FavorableTaker, Phase1Breach, WhipsawReversal)
