...
const ALLOWED_PARAMS: &[ParamSpec] = &[
    ...
    ParamSpec { name: "risk_v2.max_capital_per_market", min: 0.0, max: 100000.0 },
    ParamSpec { name: "risk_v2.closing_phase_secs", min: 0.0, max: 600.0 },
    ParamSpec { name: "risk_v2.rotation_quiet_ms", min: 0.0, max: 120000.0 },
    ParamSpec { name: "risk_v2.max_closing_pair_cost", min: 0.0, max: 1.10 },
    ParamSpec { name: "risk_v2.max_closing_attempts", min: 1.0, max: 10.0 },
    ParamSpec { name: "risk_v2.closing_retry_price_increment", min: 0.0, max: 0.10 },
    ...
    ParamSpec { name: "risk_v2.min_rebalance_interval_ms", min: 1000.0, max: 120000.0 },
